...
class AppColors {
  ...
  static List<BoxShadow> get ambientShadow => const [
        BoxShadow(color: Color(0x0D795548), blurRadius: 20, offset: Offset(0, 4)),
      ];
...
const List<Map<String, dynamic>> kSections = [
  {'key': 'agri',      'label': 'AI 农业生产', 'icon': Icons.eco,             'color': Color(0xFF0D631B)},
  {'key': 'market',    'label': '流通销售',    'icon': Icons.storefront,      'color': Color(0xFF926500)},
  {'key': 'machinery', 'label': '农机共享',    'icon': Icons.agriculture,     'color': Color(0xFF7A5649)},
  {'key': 'disaster',  'label': '气象灾害',    'icon': Icons.thunderstorm,    'color': Color(0xFFBA1A1A)},
  {'key': 'policy',    'label': '惠农政策',    'icon': Icons.account_balance, 'color': Color(0xFF2E7D32)},
  {'key': 'life',      'label': '乡村生活',    'icon': Icons.home_work,       'color': Color(0xFF734E00)},
  {'key': 'data',      'label': '数据管理',    'icon': Icons.insights,        'color': Color(0xFF40493D)},
  {'key': 'ai',        'label': 'AI 助手',     'icon': Icons.smart_toy,       'color': Color(0xFF0D631B)},
];
