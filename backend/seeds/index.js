...
async function main() {
  ...
  await prisma.diseaseKnowledge.createMany({
    data: [
      ...
      { diseaseName: '茶炭疽病', cropType: '茶叶', category: '病害', modelLabel: 'tea_anthracnose', symptoms: '叶片出现圆形或不规则褐色病斑，后期中央灰白、边缘深褐，嫩梢和成叶受害后易焦枯落叶。', cause: '炭疽病菌可在病叶和病残体上存活，连续阴雨、茶园郁闭和树势偏弱时易扩展。', prevention: '合理修剪和采摘，改善通风透光，及时清除病叶病梢，增施有机肥增强树势。', medicineAdvice: '发病初期按当地农技指导选用登记用于茶树炭疽病的药剂，严格按标签和采摘安全间隔期执行。' },
      { diseaseName: '茶饼病', cropType: '茶叶', category: '病害', modelLabel: 'tea_blister_blight', symptoms: '嫩叶叶面出现淡黄或黄绿色圆形斑，叶背隆起呈饼状并逐渐变白，严重时嫩梢畸形、芽叶品质下降。', cause: '茶饼病菌在低温高湿、云雾多、茶园通风差和嫩梢持续生长期易侵染流行。', prevention: '合理修剪控梢，降低园内湿度，及时采摘受害嫩梢，避免偏施氮肥。', medicineAdvice: '可选登记用于茶树茶饼病或叶部病害的药剂，按标签和当地农技指导轮换施用。' },
      { diseaseName: '茶小绿叶蝉', cropType: '茶叶', category: '虫害', modelLabel: 'tea_green_leafhopper', symptoms: '成虫和若虫刺吸嫩梢汁液，受害芽叶叶缘红褐、卷曲硬化，严重时出现焦边并影响茶叶品质。', cause: '茶小绿叶蝉在温暖少雨、嫩梢充足和茶园管理粗放时虫口上升较快。', prevention: '加强嫩梢期虫情监测，适度修剪和分批采摘，保护蜘蛛等天敌，达到防治指标后再用药。', medicineAdvice: '达到防治指标后选用登记用于茶树小绿叶蝉的药剂，按标签控制用量和采摘安全间隔期。' },
      { diseaseName: '茶橙瘿螨', cropType: '茶叶', category: '虫害', modelLabel: 'tea_orange_gall_mite', symptoms: '叶片受害后叶背粗糙或呈锈褐色，叶面失绿无光泽，嫩叶变厚变脆，严重时芽叶生长受抑。', cause: '茶橙瘿螨体型微小，常在叶背和嫩梢取食，干旱少雨、茶园郁闭和天敌不足时易加重。', prevention: '加强叶背检查，合理修剪清园，改善通风，保护捕食螨等天敌，避免长期滥用广谱杀虫剂。', medicineAdvice: '需要防治时选用登记用于茶树害螨的药剂，严格按标签和当地农技指导施用。' },
      { diseaseName: '猕猴桃溃疡病', cropType: '猕猴桃', category: '病害', modelLabel: 'kiwifruit_bacterial_canker', symptoms: '枝干皮孔或剪口处流出菌脓或红褐色汁液，叶片出现褐色坏死斑，花蕾和新梢可萎蔫枯死。', cause: '细菌性病害可随苗木、雨水和修剪工具传播，低温高湿、冻害和伤口多时易发生。', prevention: '使用健康苗木，冬春修剪后保护伤口，雨后排湿，及时剪除病枝并做好工具消毒。', medicineAdvice: '疑似发病应按当地农技指导处置，选用登记用于猕猴桃细菌性病害的药剂或伤口保护措施。' },
      { diseaseName: '猕猴桃褐斑病', cropType: '猕猴桃', category: '病害', modelLabel: 'kiwifruit_brown_spot', symptoms: '叶片出现褐色圆形或不规则病斑，边缘较深，病斑扩大后可连片干枯，严重时早期落叶。', cause: '病菌多在病叶和病残体上越冬，高温高湿、架面郁闭和排水不良时易扩展。', prevention: '冬季清园，生长期合理绑蔓和疏枝，改善通风透光，雨后及时排水并清除重病叶。', medicineAdvice: '发病初期按标签选用登记用于猕猴桃褐斑病或叶斑类病害的药剂，并结合农技指导轮换施用。' },
      { diseaseName: '猕猴桃灰霉病', cropType: '猕猴桃', category: '病害', modelLabel: 'kiwifruit_gray_mold', symptoms: '花器、幼果或果面出现水渍状褐斑，湿度大时病部覆盖灰色霉层，贮运期也可能腐烂扩展。', cause: '灰霉病菌在低温高湿、花期阴雨、果园郁闭和伤口多的条件下易侵染。', prevention: '花期和幼果期加强通风降湿，及时清除残花病果，减少机械伤，采后保持分级和通风贮运。', medicineAdvice: '花果期用药应选登记用于猕猴桃灰霉病或灰霉类病害的药剂，按标签和当地农技指导执行。' },
      { diseaseName: '梨黑星病', cropType: '梨', category: '病害', modelLabel: 'pear_scab', symptoms: '叶片、嫩梢和果面出现黑褐色霉状病斑，果实受害后易畸形、龟裂并降低商品性。', cause: '黑星病菌可在病叶、病梢和芽鳞中越冬，春季多雨、树冠郁闭和叶面长时间潮湿时易流行。', prevention: '清除落叶病果，剪除病梢，合理修剪改善通风透光，雨季前加强果园监测。', medicineAdvice: '可选登记用于梨黑星病或梨树病害的药剂，按标签和当地农技指导在关键期轮换施用。' },
      { diseaseName: '梨锈病', cropType: '梨', category: '病害', modelLabel: 'pear_rust', symptoms: '叶片正面出现橙黄色圆斑，后期叶背形成毛状突起，严重时早落叶并影响果实膨大。', cause: '锈病菌常在梨树与桧柏等转主寄主间传播，春季多雨和果园周边寄主多时发生较重。', prevention: '减少果园周边转主寄主病源，清除病叶，合理修剪降湿，春季新梢期加强巡查。', medicineAdvice: '发病前后按当地植保建议选用登记用于梨锈病的药剂，严格按标签剂量和安全间隔期执行。' },
      { diseaseName: '梨木虱', cropType: '梨', category: '虫害', modelLabel: 'pear_psyllid', symptoms: '若虫和成虫在嫩梢、叶背吸汁，分泌黏液和蜜露，叶片卷曲发黑并易诱发煤污。', cause: '梨木虱在梨园内越冬繁殖，春季嫩梢期虫口上升，管理粗放和天敌不足时危害加重。', prevention: '冬春清园压低虫源，保护天敌，重点监测嫩梢和叶背，达到防治指标后再用药。', medicineAdvice: '可选登记用于梨木虱的药剂，按标签轮换使用并避免长期单一作用机制用药。' },
      { diseaseName: '茄子绵疫病', cropType: '茄子', category: '病害', modelLabel: 'eggplant_phytophthora_blight', symptoms: '果实出现水渍状褐斑并迅速软腐，潮湿时表面可见白色绵毛状霉层，茎叶也可腐烂萎蔫。', cause: '疫霉类病原随雨水、灌溉水和病残体传播，高温高湿、连作和田间积水时易暴发。', prevention: '实行轮作，高畦栽培和清沟排水，避免大水漫灌，及时摘除病果病株并带出田外。', medicineAdvice: '发病初期选用登记用于茄子疫病或卵菌病害的药剂，按标签和农技指导喷施或灌根。' },
      { diseaseName: '茄子黄萎病', cropType: '茄子', category: '病害', modelLabel: 'eggplant_verticillium_wilt', symptoms: '下部叶片先发黄萎蔫，常呈半边叶或半株萎蔫，剖开茎部可见维管束褐变。', cause: '黄萎病菌在土壤中长期存活，连作、低温弱光和根系受伤会加重发病。', prevention: '与非茄科作物轮作，使用健康种苗，避免伤根和田间积水，发现重病株及时清除。', medicineAdvice: '黄萎病以预防和土壤管理为主，药剂处理应选择登记药剂并遵循当地农技指导。' },
      { diseaseName: '茄子红蜘蛛', cropType: '茄子', category: '虫害', modelLabel: 'eggplant_red_mite', symptoms: '叶背可见细小螨体和丝网，叶面出现失绿小点，严重时叶片发黄干枯、植株早衰。', cause: '红蜘蛛在高温干旱、棚室通风差和天敌受抑制时繁殖迅速。', prevention: '保持适宜湿度，清理杂草和老叶，保护捕食螨等天敌，定期检查叶背虫口。', medicineAdvice: '达到防治指标后选用登记用于茄子叶螨的药剂，按标签轮换使用并喷匀叶背。' },
      { diseaseName: '菜豆锈病', cropType: '菜豆', category: '病害', modelLabel: 'bean_rust', symptoms: '叶片出现黄色小斑，后期形成褐色粉状孢子堆，严重时叶片枯黄早落。', cause: '锈病菌借风雨传播，温暖高湿、种植过密和通风不良时扩展较快。', prevention: '选用抗病品种，合理密植，清除病残体，避免叶面长期潮湿并加强田间巡查。', medicineAdvice: '发病初期按当地植保建议选用登记用于菜豆锈病的药剂，严格按标签轮换施用。' },
      { diseaseName: '菜豆炭疽病', cropType: '菜豆', category: '病害', modelLabel: 'bean_anthracnose', symptoms: '叶脉、茎蔓和豆荚出现暗褐色凹陷斑，荚斑边缘明显，潮湿时可见粉红色孢子黏团。', cause: '炭疽病菌可随种子和病残体传播，低温高湿、连作和带露作业易加重发病。', prevention: '使用健康种子，轮作换茬，清除病残体，避免雨后或带露整枝采收。', medicineAdvice: '可选登记用于菜豆炭疽病的药剂，按标签在发病初期施用并注意采收安全间隔期。' },
      { diseaseName: '豆荚螟', cropType: '菜豆', category: '虫害', modelLabel: 'bean_pod_borer', symptoms: '幼虫蛀入花蕾、嫩荚或豆粒取食，荚面可见蛀孔和虫粪，造成落花落荚和豆粒受损。', cause: '成虫在花荚期产卵，幼虫钻蛀后隐蔽危害，温暖湿润和虫源基数高时发生较重。', prevention: '清除田间残株和落荚，结合灯诱或性诱监测成虫，抓住卵孵盛期和低龄幼虫期防治。', medicineAdvice: '达到防治指标后选用登记用于豆类豆荚螟或鳞翅目害虫的药剂，按标签和农技指导适期施用。' },
      { diseaseName: '西瓜枯萎病', cropType: '西瓜', category: '病害', modelLabel: 'watermelon_fusarium_wilt', symptoms: '苗期或伸蔓后叶片中午萎蔫、早晚恢复，随后整株黄化枯死，茎基部剖开可见维管束褐变。', cause: '枯萎病菌在土壤中长期存活，连作、土壤酸化和根系受伤时发病加重。', prevention: '与非瓜类作物轮作，选用抗病品种或嫁接苗，清沟排水，避免伤根和重茬栽培。', medicineAdvice: '以轮作和健康种苗预防为主，药剂灌根须选登记药剂并按标签和农技指导执行。' },
      { diseaseName: '西瓜炭疽病', cropType: '西瓜', category: '病害', modelLabel: 'watermelon_anthracnose', symptoms: '叶片出现近圆形褐斑，茎蔓病斑凹陷开裂，果实形成暗褐色凹陷斑并可见粉红色黏孢团。', cause: '炭疽病菌可随种子和病残体传播，高温高湿、连作和雨水飞溅有利于流行。', prevention: '使用健康种子，轮作换茬，及时清除病蔓病果，雨后排水并降低田间湿度。', medicineAdvice: '发病初期选用登记用于西瓜炭疽病的药剂，按标签剂量、安全间隔期和农技指导轮换使用。' },
      { diseaseName: '西瓜蔓枯病', cropType: '西瓜', category: '病害', modelLabel: 'watermelon_gummy_stem_blight', symptoms: '茎蔓节部出现褐色水渍状病斑，后期开裂并流出胶状物，叶片可见不规则褐斑。', cause: '蔓枯病菌随病残体、种子和雨水传播，棚内高湿、伤口多和连作田块易发。', prevention: '轮作倒茬，合理整枝减少伤口，及时清除病蔓，棚室加强通风排湿。', medicineAdvice: '可选登记用于瓜类蔓枯病的药剂，按标签在发病初期喷施并注意轮换作用机制。' },
      { diseaseName: '姜瘟病（姜腐烂病）', cropType: '生姜', category: '病害', modelLabel: 'ginger_bacterial_wilt', symptoms: '植株叶片先萎蔫下垂，茎基部和姜块水渍状腐烂，挤压病部可见乳白色菌脓或异味。', cause: '多为土传细菌性病害，病姜、带菌土壤和灌溉水可传播，高温高湿和田间积水时易暴发。', prevention: '选用健康姜种，与非寄主作物轮作，深沟高畦排水，发现病株及时连土移除并消毒病穴。', medicineAdvice: '疑似姜瘟应先请农技人员确认，药剂或土壤处理必须选登记产品并严格按标签执行。' },
      { diseaseName: '姜斑点病', cropType: '生姜', category: '病害', modelLabel: 'ginger_leaf_spot', symptoms: '叶片出现黄褐色小斑，逐渐扩大为长椭圆形或不规则褐斑，严重时叶片枯黄早衰。', cause: '叶斑类病原在高温高湿、通风不良和病残体多的姜田中易反复侵染。', prevention: '合理密植，清沟排水，清除病叶病残体，避免偏施氮肥并保持植株健壮。', medicineAdvice: '发病初期按当地植保建议选用登记用于生姜叶斑病的药剂，按标签均匀喷施。' },
      { diseaseName: '大蒜叶枯病', cropType: '大蒜', category: '病害', modelLabel: 'garlic_leaf_blight', symptoms: '叶尖或叶片出现灰白至褐色长条斑，病斑扩展后叶片枯黄，潮湿时可见霉状物。', cause: '病菌随病残体和气流传播，低温高湿、田间郁闭和氮肥过量时发病较重。', prevention: '轮作换茬，合理密植，清除病残叶，控制氮肥并及时排水降湿。', medicineAdvice: '可选登记用于大蒜叶枯病或叶部病害的药剂，按标签和当地农技指导在发病初期施用。' },
      { diseaseName: '葱蓟马', cropType: '葱', category: '虫害', modelLabel: 'onion_thrips', symptoms: '成虫和若虫锉吸叶片汁液，叶面出现银白色条斑和小黑点，严重时叶片扭曲干尖。', cause: '葱蓟马在温暖干燥、田间杂草多和连作葱蒜类作物时繁殖较快。', prevention: '清除田边杂草和残株，覆盖银灰膜或悬挂蓝板监测，保护天敌并避免过度干旱。', medicineAdvice: '达到防治指标后选用登记用于葱蓟马的药剂，按标签轮换用药并重点喷施心叶和叶鞘。' },
      { diseaseName: '葱霜霉病', cropType: '葱', category: '病害', modelLabel: 'onion_downy_mildew', symptoms: '叶片出现淡黄绿色长椭圆病斑，潮湿清晨病部可见灰紫色霉层，严重时叶片折倒枯死。', cause: '霜霉病菌在低温高湿、露水重和通风不良条件下传播迅速。', prevention: '选用健康种苗，合理密植，雨后及时排水，避免大水漫灌并清除病残体。', medicineAdvice: '发病初期选用登记用于葱类霜霉病的药剂，按标签和农技指导交替施用。' },
      { diseaseName: '莲藕腐败病', cropType: '莲藕', category: '病害', modelLabel: 'lotus_rhizome_rot', symptoms: '叶片由边缘发黄萎蔫，藕鞭和地下茎褐变腐烂，严重时整片藕田植株衰败倒伏。', cause: '腐败病病原可在带病种藕和淤泥中存活，高温、浅水缺氧和连作田块易加重。', prevention: '选用无病种藕，轮作或更换藕田，保持适宜水层，清除病残藕并避免带病调运。', medicineAdvice: '以健康种藕和田间水肥管理为主，药剂处理需选登记产品并按标签及农技指导使用。' },
      { diseaseName: '莲藕褐斑病', cropType: '莲藕', category: '病害', modelLabel: 'lotus_brown_spot', symptoms: '叶片出现圆形或不规则褐色斑，边缘较深，病斑增多后叶片早衰干枯并影响藕膨大。', cause: '病菌随病残叶越冬，梅雨季和高湿郁闭环境下借风雨传播扩展。', prevention: '及时摘除重病叶，保持合理密度和通风，秋后清理病残体，避免偏施氮肥。', medicineAdvice: '发病初期按当地植保建议选用登记用于莲藕叶斑类病害的药剂，严格按标签施用。' },
    ],
  })
